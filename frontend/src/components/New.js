          ...
          <div className="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">A Front-End Developer is someone who creates websites and web applications. </p>
                 {/* <a href="#" class="btn " >SELECT</a>  */}
                   <Link type="btn" class="btn btn-primary btn" to='/Signup'>SELECT</Link>    
          ...
          <div className="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">The practice of defending computers, servers, mobile devices, electronic systems, networks, and data from malicious attacks. .</p>
             
                  <Link type="btn" class="btn btn-primary " to='/Signup'>SELECT</Link>
                   {/* <Link type="btn mar" to='/Slider'>MORE
                    </Link>  */}
                    <Link type="btn" class="btn btn-secondary " to='/Slider'>MORE</Link>
              </div>
          ...
          <div className="col-md-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text"></p>Graphic design is a craft where professionals create visual content to communicate messages.
                <Link type="btn" class="btn btn-primary btn" to='/Signup'>SELECT</Link>
                  {/* <a href="Slider.js" class="btn btn-primary  mar">MORE</a>    */}
...
and work with the data they need in appropriate ways..</p>
                <Link type="btn" class="btn btn-primary btn" to='/Signup'>SELECT</Link>
